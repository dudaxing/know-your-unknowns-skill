...
**Step 3 — Only after a bound confirm arrives, implement** — reimplement into the target stack's idioms and the project's existing conventions; never transplant code verbatim.
